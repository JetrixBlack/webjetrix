...
<footer class="bg-navy-dark text-white py-16 border-t border-white/5">
    <div class="max-w-7xl mx-auto px-5 sm:px-6 md:px-8 lg:px-10 xl:px-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div class="flex flex-col gap-6">
                ...
                <p class="text-white/50 text-sm leading-relaxed pr-8">
                    Creamos sitios web estratégicos y soluciones digitales diseñadas para convertir visitas en clientes
                    reales.
                </p>
            </div>
            <!-- Columna 2: Enlaces rápidos a Servicios -->
            <div class="flex flex-col gap-4">
                ...
                <a class="text-white/50 hover:text-electric-blue transition-colors text-sm"
                    href="servicios.php">Desarrollo Web</a>
                <a class="text-white/50 hover:text-electric-blue transition-colors text-sm"
                    href="servicios.php">Chatbots con IA</a>
                <a class="text-white/50 hover:text-electric-blue transition-colors text-sm"
                    href="servicios.php">Ecommerce</a>
                <a class="text-white/50 hover:text-electric-blue transition-colors text-sm" href="servicios.php">Agenda
                    Pro</a>
            </div>
            <!-- Columna 3: Enlaces institucionales / Empresa -->
            <div class="flex flex-col gap-4">
                <h4 class="font-bold text-white uppercase tracking-wider text-sm">Empresa</h4>
                <a class="text-white/50 hover:text-electric-blue transition-colors text-sm" href="sobre-mi.php">Sobre
                    mí</a>
                <a class="text-white/50 hover:text-electric-blue transition-colors text-sm" href="proyectos.php">Casos
                    de éxito</a>
                <a class="text-white/50 hover:text-electric-blue transition-colors text-sm" href="blog.php">Blog</a>
                <a class="text-white/50 hover:text-electric-blue transition-colors text-sm"
            ...
            <div class="flex flex-col gap-4">
                ...
                <p class="text-xs text-white/40">Recibe insights técnicos semanales.</p>
            </div>
        </div>
        ...
        <div
            ...
            <!-- Año generado dinámicamente con PHP -->
            <div class="flex gap-8">
                <a class="hover:text-white transition-colors" href="privacidad.php">Política de privacidad</a>
                <a class="hover:text-white transition-colors" href="terminos.php">Términos y condiciones</a>
            </div>
        </div>
    </div>
</footer>

<!-- Script de conversión de moneda para mostrar precios en USD, EUR o Bs. -->
<script>
(function() {
    // IIFE para evitar contaminar el ámbito global
    ...
    // Formatea el valor numérico según la moneda seleccionada
    ...
    // Actualiza todos los precios en pantalla según la moneda y tasas vigentes
    ...
    // Asigna eventos click a cada botón de moneda para alternar la visualización
