...
<footer class="bg-navy-dark text-white py-16 border-t border-white/5">
    <div class="max-w-7xl mx-auto px-5 sm:px-6 md:px-8 lg:px-10 xl:px-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div class="flex flex-col gap-6">
                ...
                <p class="text-white/50 text-sm leading-relaxed pr-8">
                    Creamos sitios web estrategicos y soluciones digitales diseñadas para convertir visitas en clientes
                    reales.
                </p>
            </div>
            ...
            <div class="flex flex-col gap-4">
                ...
                <a class="text-white/50 hover:text-electric-blue transition-colors text-sm" href="/servicios">Desarrollo
                    Web</a>
                <a class="text-white/50 hover:text-electric-blue transition-colors text-sm" href="/servicios">Chatbots
                    con IA</a>
        ...
        <div
            ...
            <!-- Año generado dinamicamente con PHP -->
            <div class="flex gap-8">
                <a class="hover:text-white transition-colors" href="/privacidad">Política de privacidad</a>
                <a class="hover:text-white transition-colors" href="/terminos">Términos y condiciones</a>
            </div>
        </div>
    </div>
</footer>
